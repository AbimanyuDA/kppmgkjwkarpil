...
import { Home, FileText, Upload, DollarSign, Users, LogOut, Menu } from 'lucide-react'
...
export default function DashboardLayout({ children }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { href: '/dashboard/upload', icon: Upload, label: 'Upload Nota' },
    { href: '/dashboard/reports', icon: DollarSign, label: 'Laporan' },
    { href: '/dashboard/users', icon: Users, label: 'Kelola User', adminOnly: true },
  ]
